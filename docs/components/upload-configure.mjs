 ...
 *   injectedWallets: { info: { uuid: string, name: string, icon: string, rdns: string }, provider: import("../services/eip6963.mjs").Eip1193Provider }[],
 *   walletAddress: string | null,
 *   connectedWalletName: string | null,
 *   walletBusy: boolean,
 *   walletError: string | null,
 *   connectingUuid: string | null,
 *   onConnectInjected: (provider: import("../services/eip6963.mjs").Eip1193Provider, info: { uuid: string, name: string }) => void | Promise<void>,
